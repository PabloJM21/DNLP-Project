...
def train_multitask(args):
    ...
    filepath = f"/kaggle/working/models/{args.option}-{args.epochs}-{args.lr}-qqp.pt"
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=(
            "/kaggle/working/predictions/bert/sts-main-similarity-dev-output.csv"
            if not args.task == "multitask"
    ...
    parser.add_argument(
        ...
        type=str,
        default=(
            "/kaggle/working/predictions/bert/sts-main-similarity-test-output.csv"
            if not args.task == "multitask"
